...
const AdminHeader = () => {
  return (
    <header
      className="
  fixed top-0 left-[290px] right-0 bg-white text-[#344054] flex items-center justify-between px-6 font-bold text-[18px] border-b border-[#e0e0e0]"
    >
      ...
      <div className="gap-5 flex items-center py-4 px-0">admin</div>
    </header>
  );
};
