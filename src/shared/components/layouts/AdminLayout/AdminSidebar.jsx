  ...
  return (
    <aside className="fixed top-0 left-0 h-screen w-[290px] bg-white border-r border-[#e0e0e0] px-5 box-border flex flex-col">
      <div className="flex items-center justify-center py-8">
        <NavLink to={ROUTES.ADMIN.DASHBOARD} className="text-2xl font-medium">
          ADMIN PANEL
        </NavLink>
      </div>
        ...
        <nav>
          ...
          <ul className="flex flex-col gap-1">
            ...
            <li>
              ...
              >
                <span className="text-gray-500">
                  <i className="fi fi-rr-users text-base" />
                </span>
                <span className="text-gray-700 text-sm font-medium">Users</span>
              </NavLink>
            </li>
